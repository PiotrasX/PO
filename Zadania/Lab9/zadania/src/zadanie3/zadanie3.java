...
public class zadanie3
{
    public static void main(String[] args)
    {
        try
        {
            DataOutputStream zapis = new DataOutputStream(new FileOutputStream("C:\\Users\\piotr\\Desktop\\Studia\\Semestr 2\\PO\\Zadania\\Lab9\\zadania\\src\\zadanie3\\dataUrodzin.txt"));
