...
public class Main
{
    public static void main(String[] args)
    {
        ...
        // Listę możemy zasadniczo zdefiniować jako bardziej elastyczną wersję tablicy. Jest to jednak pewne uproszczenie,
        // dlatego też przyjrzyjmy się teraz dokładnie jakie są cechy charakterystyczne list:
